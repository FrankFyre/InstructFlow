...
class ChecklistCreator extends StatefulWidget {
  @override
  _ChecklistCreatorState createState() => _ChecklistCreatorState();
}

class _ChecklistCreatorState extends State<ChecklistCreator> {
  ...
  void initState() {
    ...
    keyid = '';
    steps = [checklistintruct(description: '', count: 1, isvideo: false)];
    getImageUrls(steps);
  ...
  Future<void> createChecklist() async {
    final checklistclass newchecklist = checklistclass(
      name: nameController.text,
      keyid: '',
      description: List.from(steps),
    );

    await FirebaseUtils.saveNewCheckToFirebase(
      newchecklist,
      nameController,
      steps,
      context,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () async {
                                progresindi();
                                await saveGetStorageUrls(); // Call the function here
                                createChecklist();
                                Navigator.of(context).pop();
                                Navigator.of(context).pop();
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          setState(() {
                            deletestep(index); // Remove the step from the list
                          });
