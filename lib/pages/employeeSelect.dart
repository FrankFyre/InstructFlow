...
import 'package:instructflow/dashboard/dashboard.dart';
import 'package:instructflow/managers/Employee/employeeeditor.dart';
...
class EmployeeSelect extends StatefulWidget {
  ...
  EmployeeSelect({required this.stateroute});
...
class _EmployeeSelectState extends State<EmployeeSelect> {
  ...
  _navigatePage(Employee employee) {
    if (widget.stateroute == 1) {
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              EmployeDash(employee: employee), // Pass the selected recipe here
        ),
      );
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => EmployeeEditor(
              employee: employee), // Pass the selected recipe here
        ),
      );
    } else if (widget.stateroute == 3) {
      Navigator.pop(context, employee.name);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: FutureBuilder<List<List<Employee>>>(
